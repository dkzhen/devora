        ...
        <div className="space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProjects.map((project, idx) => (
                    <div 
                        key={idx}
                        onClick={() => router.push(`/web3-projects/${project.slug}`)}
                        className="group relative bg-[#0a0312] border border-[#ffd89b]/20 rounded-2xl p-5 hover:border-[#ffd89b]/50 transition-all duration-300 cursor-pointer overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.3)]"
                    >
                        {/* Hover Gradient Overlay */}
                        <div className="absolute inset-0 bg-linear-to-br from-[#ffd89b]/5 via-transparent to-[#19547b]/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                        ...
                        <div className="relative z-10 flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                <h3 className="text-base font-bold text-white group-hover:text-[#ffd89b] transition-colors truncate uppercase tracking-wider">{project.name}</h3>
