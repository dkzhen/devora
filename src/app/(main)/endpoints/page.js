...
export default function EndpointsPage() {
    ...
    const [activeCategory, setActiveCategory] = useState(apiCategories[0]?.category);
                            ...
                            <div className="bg-[#0c0e1a]/80 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-xl">
                                ...
                                <div className="px-6 py-5 border-b border-white/5 bg-linear-to-r from-blue-900/10 to-transparent flex flex-col sm:flex-row sm:items-center gap-3">
                                    ...
                                    <div className="ml-12 sm:ml-auto">
                                        <span className="inline-flex text-xs font-semibold text-blue-300 bg-blue-500/10 border border-blue-500/20 px-3 py-1 rounded-full shrink-0">
                                            {displayCategory.endpoints.length} Endpoint{displayCategory.endpoints.length !== 1 ? 's' : ''}
                                        </span>
                                    </div>
                                </div>
                                ...
                                {/* Endpoints */}
                                <div>
                                    {displayCategory.endpoints.map((ep, idx) => {
