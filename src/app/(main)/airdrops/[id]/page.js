                                                ...
                                                {newSteps.map((step, index) => (
                                                    <div key={index} className="bg-[#0c0e1a]/40 border border-white/5 hover:border-white/10 rounded-xl p-4 relative group">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-[#0a0312] border border-white/10 focus:border-[#F25278] focus:shadow-[0_0_15px_rgba(242,82,120,0.1)] rounded-lg px-3 py-2 text-sm text-white focus:outline-none mb-3"
                                                        ...
                                                        <div className="grid grid-cols-2 gap-3">
                                                            <input
                                                                ...
                                                                className="w-full bg-[#0a0312] border border-white/10 focus:border-[#F25278] focus:shadow-[0_0_15px_rgba(242,82,120,0.1)] rounded-lg px-3 py-2 text-xs text-white focus:outline-none"
