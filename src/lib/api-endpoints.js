export const apiCategories = [
    ...
    },
    {
        ...
        endpoints: [
            { method: 'GET', path: '/api/herosms-client/balance', desc: 'Retrieve current virtual number service balance' },
            { method: 'GET', path: '/api/herosms-client/config', desc: 'Get configuration status for Smart OTP provider' },
            { method: 'POST', path: '/api/herosms-client/config', desc: 'Update provider API credentials', sampleBody: '{\n  "apiKey": "your_hero_sms_key"\n}' },
            { method: 'DELETE', path: '/api/herosms-client/config', desc: 'Remove provider configuration from user profile' },
            { method: 'GET', path: '/api/herosms-client/countries', desc: 'List all available countries for virtual numbers' },
            { method: 'GET', path: '/api/herosms-client/services', desc: 'List available services (Telegram, Google, etc) for a country', sampleBody: '?country=0' },
            { method: 'GET', path: '/api/herosms-client/operators', desc: 'List available mobile operators for a country', sampleBody: '?country=0' },
            { method: 'GET', path: '/api/herosms-client/prices', desc: 'Get real-time pricing for a service in a country', sampleBody: '?service=tg&country=0' },
            { method: 'POST', path: '/api/herosms-client/number', desc: 'Purchase/Order a new virtual number', sampleBody: '{\n  "service": "tg",\n  "country": "0",\n  "maxPrice": 10\n}' },
            { method: 'GET', path: '/api/herosms-client/number', desc: 'Get SMS status for a specific activation', sampleBody: '?id=12345' },
            { method: 'DELETE', path: '/api/herosms-client/number', desc: 'Relase or cancel a virtual number early', sampleBody: '?id=12345' },
            { method: 'GET', path: '/api/herosms-client/status', desc: 'Check activation status (Hero SMS/SMS-Activate compatible)', sampleBody: '?id=12345' },
            { method: 'PUT', path: '/api/herosms-client/status', desc: 'Update activation status (Ready, Complete, Resend)', sampleBody: '{\n  "id": "12345",\n  "status": 3\n}' },
            { method: 'GET', path: '/api/herosms-client/activations', desc: 'List all currently active virtual numbers' },
