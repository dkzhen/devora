    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 text-center">
            <div className="relative mb-8">
                ...
                <div className="w-24 h-24 rounded-3xl bg-[#0c0e1a]/80 border border-white/10 flex items-center justify-center shadow-2xl backdrop-blur-md relative overflow-hidden group">
            ...
            <p className="max-w-md text-slate-400 leading-relaxed mb-10 text-sm">
